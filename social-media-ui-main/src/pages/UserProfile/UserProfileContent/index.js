        ...
        <div style={{ marginLeft: isHeaderLayout ? '0' : '25rem', marginTop: isHeaderLayout ? '6rem' : '0' }}>
            <Modal show={modal} onHide={() => setModal(false)} centered>
                <Modal.Header closeButton>
                    <Modal.Title>Xóa bạn</Modal.Title>
                </Modal.Header>
                <Modal.Body>Bạn có muốn xóa bạn bè với {userProfile.name}?</Modal.Body>
                <Modal.Footer>
                        ...
                        <div className={cx('content')}>
                            ...
                            <div className={cx('profile-follow')}>
                                <h5 className={cx('profile-follow-count')}>
                                    <span>{listPost.length}</span> {listPost.length > 1 ? 'posts' : 'bài đăng'}
                                </h5>
                                <h5 className={cx('profile-follow-count')}>
                                    <span>{userProfile.countFriend}</span>{' '}
                                    {userProfile.countFriend > 1 ? 'friends' : 'bạn bè'}
                                </h5>
                                <h5 className={cx('profile-follow-count')}>
                                    <span>{userProfile.countCommonFriend}</span>{' '}
                                    {userProfile.countCommonFriend > 1 ? 'mutual friends' : 'bạn chung'}
                                </h5>
                            </div>
