        ...
        <div className={cx('create-post')}>
            ...
            <div className={cx('wrapper')}>
                <div className={cx('post-title')}>
                    <span>{data ? 'Chỉnh sửa bài đăng' : 'Tạo bài đăng mới'}</span>
                </div>
                    ...
                    <div className={cx('bottom')}>
                        ...
                        {pictures.length === 0 && newPictures.length === 0 && (
                            <div className={cx('wrap-title')}>
                                <label className={cx('wrap-title')} htmlFor="post" role="button">
                                    <MdOutlinePhotoSizeSelectActual style={{ fontSize: '3.5rem' }} />
