...
const ProfileContent = () => {
    ...
    return (
        <div style={{ marginLeft: isHeaderLayout ? '0' : '25rem', marginTop: isHeaderLayout ? '6rem' : '0' }}>
            ...
            >
                <ModalHeader closeButton={true}>Danh sách bạn</ModalHeader>
                <ModalBody>
                    <div style={{ padding: '1rem' }}>
                        <input placeholder="Tìm bạn bè..." className={cx('input-search')} type="text" />
                    </div>
                                ...
                                return (
                                    <div className={cx('friend-item')} key={friend.username}>
                                        ...
                                        <div className={cx('friend-btn')}>
                                            <button onClick={() => unFollow(friend.username)}>Xóa bạn</button>
                                        </div>
                                    </div>
                                );
                            })}
            ...
            <Modal centered show={modal2} onHide={() => setModal2(!modal2)}>
                <ModalHeader closeButton={true}>Xác nhận thay đổi</ModalHeader>
                <ModalBody>
                        ...
                        <div className={cx('content')}>
                            ...
                            <div className={cx('profile-follow')}>
                                <h5 className={cx('profile-follow-count')}>
                                    <span>{listPost.length}</span> bài đăng
                                </h5>
                                <h5
                                ...
                                >
                                    <span>{countFriend}</span> {countFriend > 1 ? 'friends' : 'bạn bè'}
                                </h5>
                            </div>
